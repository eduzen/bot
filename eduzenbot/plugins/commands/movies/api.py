...
from eduzenbot.plugins.commands.movies.constants import BASEURL_IMAGE, YT_LINK, YTS_API
...
def get_basic_info(movie):
    ...
    try:
        ...
        logfire.exception("pelis could not find a release date")
        year = "2050"
...
def get_yts_torrent_info(imdb_id):
    try:
        ...
        logfire.info("yts api no responde.")
        return None
    if r.status_code == 200:
        ...
        try:
            ...
            logfire.exception("There was a problem with yts api response")
