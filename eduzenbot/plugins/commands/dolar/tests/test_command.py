...
def test_get_dolar(mocker):
    ...
    mock_get_banco_nacion = mocker.patch("eduzenbot.plugins.commands.dolar.command.get_banco_nacion")
    mock_get_banco_nacion.return_value = "ok"
    mock_get_bluelytics = mocker.patch("eduzenbot.plugins.commands.dolar.command.get_bluelytics")
    mock_get_bluelytics.return_value = "ok"
    mock_get_dolar_blue_geeklab = mocker.patch("eduzenbot.plugins.commands.dolar.command.get_dolar_blue_geeklab")
    mock_get_dolar_blue_geeklab.return_value = "ok"
    mock_create_user = mocker.patch("eduzenbot.plugins.commands.dolar.command.create_user")
